# Audit Report: Workflow `69751a2167c847a894f2d5d3c78b8a9d`

## Overview
- Source JSON: `reports\workflow-report-69751a2167c847a894f2d5d3c78b8a9d.json`
- Run ID: `69751a2167c847a894f2d5d3c78b8a9d`
- Papers input: `papers\Calorie Posting in Chain Restaurants - Bollinger et al. (2011).pdf`
- Started at: `2026-02-16T04:34:15.281488+00:00`
- Finished at: `2026-02-16T04:43:25.512897+00:00`
- Duration: `0:09:10.231409`
...
- Identification strategy
  ...
  - Model (for outcome y_it, e.g., calories per store-day or per transaction):
    y_it = α_i + γ_t + β Post_it + X_it'θ + ε_it
    - Post_it = 1 if NYC store after 1 Apr 2008; α_i are store fixed effects; γ_t are time controls (week/day, etc.); X_it includes controls (weather, etc.).
...
- Key results
  ...
  - Quantile-based effects
    - Larger reductions at higher calories-per-transaction quantiles; ~5–6% reduction from the 75th to the 99th percentile; 10th percentile near zero. (Provenance: page 22)
